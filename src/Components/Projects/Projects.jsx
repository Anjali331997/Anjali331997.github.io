...
function Projects() {
  return (
    <section id="projects" fluid className="project-card container">

      <h1 className="project-heading section__title">
        My Recent <strong className="purple">Works </strong>
      </h1>
      <p style={{ divor: "black" }} className="section__subtitle">
        Here are a few projects I've worked on recently.
      </p>
      <div style={{ justifyContent: "center", paddingBottom: "10px" }} className="projects__div">
        <div md={6} className="project-card" >
          <ProjectCards
        ...
        <div md={6} className="project-card">
          <ProjectCards
            ...
            description="Plant Order Application - the ultimate green companion at your
              fingertips. Bdivse, select, and order from our wide range of exquisite plants for delivery to
